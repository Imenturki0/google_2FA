  ...
  <body>
    <div class="tab-container">
      ...
      <div id="recipientTab" class="tabcontent">
        ...
        <div class="input-container">
          <label class="col-sm-4 col-form-label">العملة المرسلة</label>
          <div class="col-sm-8">
            ...
            <div class="form-group row">
              <label class="col-sm-4 col-form-label">المبلغ المرسل</label>
              <div class="col-sm-8">
        ...
        <div class="input-container">
          <div class="form-group row">
            <label class="col-sm-2 col-form-label">تأمين الحوالة</label>
            <div class="col-sm-8">
              <div style="padding: 24px;" class="form-control">تمكنك هذه الخاصية بتأمين الحوالة بإختيار إحدى الصور وتزويد الزبون بمضمونها حيث لا يمكن للمكتب التسليم بدون معلومات الصورة</div>
            </div>
            <div class="col-sm-2" style="padding-right: 0;">
              <span id="selsecimg" class="form-control" style="text-align: center;height: 55px;vertical-align: middle;display: table-cell;cursor: pointer;background: #162f6e;color: #fff;" data-toggle="modal" data-target="#exampleModal-setsecimg">تحديد الصورة</span>
              <input id="selseccode" class="" value="0" type="hidden">
            </div>
          </div>
        </div>  
